...
{
    /**
     * @Route("/admin/homepage/index", name="homepage_index", methods={"GET"})
     */
     ...
     */
    public function about(HomepageRepository $homepageRepository): Response
    {
    ...
    /**
     * @Route("/admin/homepage/{id}/delete", name="homepage_delete", methods={"DELETE"})
     */
