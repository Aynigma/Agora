...
class __TwigTemplate_87902071ab88c3385323e8ce50e147a8b422b4b18be96bdaf358942e9d4c1460 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["other_article"]) {
            // line 14
            echo "            ";
            if ( !(twig_get_attribute($this->env, $this->source, $context["other_article"], "id", [], "any", false, false, false, 14) === twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 14, $this->source); })()), "id", [], "any", false, false, false, 14))) {
                // line 15
                echo "                <div class=\"col-md-4 col-sm-6 col-xs-12\">
                    <div class=\"full news_blog\">
                        <img class=\"img-responsive\" src=\"";
                // line 17
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((("images/b" . twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 17)) . ".png")), "html", null, true);
                echo "\" alt=\"#\" />
                        <div class=\"overlay\">><a class=\"main_bt transparent\" href=\"";
                // line 18
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("article_show", ["id" => twig_get_attribute($this->env, $this->source, $context["other_article"], "id", [], "any", false, false, false, 18)]), "html", null, true);
                echo "\">Voir</a></div>
                        <div class=\"blog_details\">
                            <h3>";
                // line 20
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["other_article"], "title", [], "any", false, false, false, 20), "html", null, true);
                echo "</h3>
                            <p>";
                // line 21
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["other_article"], "subtitle", [], "any", false, false, false, 21), "html", null, true);
                echo "</p>
                        </div>
                    </div>
                </div>
...
";
    ...
    {
        return array (  166 => 27,  152 => 26,  144 => 21,  140 => 20,  135 => 18,  131 => 17,  127 => 15,  124 => 14,  107 => 13,  101 => 10,  97 => 9,  93 => 8,  88 => 7,  78 => 6,  59 => 4,  36 => 2,);
    }
