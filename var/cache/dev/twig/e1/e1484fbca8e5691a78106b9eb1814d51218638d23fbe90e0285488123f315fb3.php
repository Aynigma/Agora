...
class __TwigTemplate_e1a0f015b7241d9cf94586296b1f93dcc8c3104fff966cb00a0328e4bcdb05f2 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <tbody>
            <tr>
                ...
                <td>";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 10, $this->source); })()), "name", [], "any", false, false, false, 10), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Adresse email</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 18, $this->source); })()), "title", [], "any", false, false, false, 18), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  121 => 25,  116 => 23,  108 => 18,  101 => 14,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <br><br><br>{{ include('contact/_delete_form.html.twig') }}
{% endblock %}
