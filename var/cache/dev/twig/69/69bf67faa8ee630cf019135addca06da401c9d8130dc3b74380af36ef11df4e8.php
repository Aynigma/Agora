...
class __TwigTemplate_36d54f6fdbb018d3ea097bb64434623c75275b7eae6b32ced88c66f4c266e5de extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_logo($context, array $blocks = [])
    {
        ...
        echo "\" style=\"height: 110px;\" alt=\"image\">
    </a>
";
...
";
    ...
    {
        return array (  204 => 33,  189 => 34,  187 => 33,  179 => 27,  169 => 26,  157 => 22,  153 => 21,  148 => 20,  138 => 19,  124 => 14,  120 => 12,  110 => 11,  97 => 7,  92 => 6,  82 => 5,  63 => 3,  40 => 1,);
    }
...
{% block logo %}
    <a class=\"navbar-brand\" href=\"{{ path('admin_index')}}\">
        <img src=\"{{asset('images/logo.png')}}\" style=\"height: 110px;\" alt=\"image\">
    </a>
{% endblock %}
...
{% block navbar_links %}
    <li><a class=\"nav-link active\" href=\"{{ path('homepage_index')}}\">Page d'accueil</a></li>
    <li><a class=\"nav-link active\" href=\"{{ path('admin_article_index')}}\">Gestion des actualités</a></li>
...
{% endblock %}", "admin/layout.html.twig", "/opt/lampp/htdocs/Symfony-L3/templates/admin/layout.html.twig");
    }
}
